...
set title "OpenAtom on Blue Gene/P"
...
set key center
set xtics ("32" 32, "64" 64, "128" 128, "256" 256, "512" 512, "1K" 1024, "2K" 2048, "4K" 4096, "8K" 8192, "16K" 16384, "32K" 32768, "64K" 65536, "128K" 131072) nomirror

set output "bgp.pdf"

plot 'bgp.dat' u 1:3 t "W256" with linespoints ls 1, \
'bgp.dat' u 1:2 t "W32" with linespoints ls 2
