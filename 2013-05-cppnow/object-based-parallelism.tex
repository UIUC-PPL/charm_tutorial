{
\usebackgroundtemplate{  \includegraphics[width=\paperwidth]{../figures/progmodel/01-objects-for-algo.pdf} }
\begin{frame}[t]
...
\begin{frame}
  \frametitle{
    \only<1>{Concurrency requires distributing objects across processors}
...
\begin{frame}
  \frametitle{
    ...
    \only<2>{Globally visible objects = chares}
    \only<3>{Globally visible object collections = chare arrays}
  }
