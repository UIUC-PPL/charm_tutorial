...
\item Insert \code{if (myLBStep) AtSync();} call at natural barrier
...
\begin{itemize}    
    ...
    \begin{itemize}
       ...
       \item Frequent load balancing leads to high overhead and no benefit
       \item Infrequent load balancing leads to load imbalance and results in no gains
    \end{itemize}
...
\begin{frame}[fragile]
  \frametitle{Fractography with No Load Balancing}
  \begin{columns}
    \begin{column}[T]{2.8in}
      \includegraphics[width=2.8in, height=1.5in]{figures/without-meta-util}
    \end{column}
    \begin{column}[T]{5cm}
      \begin{itemize}
        \item[]
        \item Large variation in processor utilization 
        \item Low utilization leading to resource wastage 
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Fractography with Meta-Balancer}
  \begin{columns}
    \begin{column}[T]{2.8in}
      \includegraphics[width=2.8in, height=1.5in]{figures/meta-util}
    \end{column}
    \begin{column}[T]{5cm}
      \begin{itemize}
        \vspace {-0.25cm}
        \item Identifies the need for frequent load balancing in the beginning 
        \item Frequency of load balancing decreases as load becomes balanced
        \item Increases overall processor utilization and gives gain of $31\%$
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
