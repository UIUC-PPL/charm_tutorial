...
\frametitle{NAMD Projections}
  \begin{center} \includegraphics[width=\textwidth]{figures/namd_projection.pdf} \end{center}
\end{frame}
...
\frametitle{NAMD Performance on Titan}
  \begin{center} \includegraphics[width=\textwidth]{figures/namd_titan.pdf} \end{center}
\end{frame}
...
\frametitle{OpenAtom: Topology Aware Mapping of Objects}
  \begin{center} \includegraphics[width=.5\textwidth]{figures/openatom_topo.pdf} \end{center}
